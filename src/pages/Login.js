...
const Login = () => {
  return (
    <div className="w-full relative bg-ghostwhite flex flex-col items-center justify-start pt-0 px-0 pb-[46px] box-border gap-[29px] text-left text-5xl text-light-popo font-ui-type-text-md-s">
